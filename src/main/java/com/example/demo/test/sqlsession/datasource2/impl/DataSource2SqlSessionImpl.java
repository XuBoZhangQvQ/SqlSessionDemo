package com.example.demo.test.sqlsession.datasource2.impl;
...
@DS("datasource2")
@Slf4j
public class DataSource2SqlSessionImpl implements DataSource2SqlSession {
     ...
     * 使用构造方法注入
     */
    public DataSource2SqlSessionImpl(SqlSessionTemplate sqlSessionTemplate) {
